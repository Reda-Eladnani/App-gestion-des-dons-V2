...
<head>
  ...
  <title>Profil de ${sessionScope.nomAsso}</title>
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="ProfilDonnateur">Retour a votre Profil</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container">
    ...
    <header class="jumbotron my-4" >
      ...
      <p class="lead">Vous trouverez ici les evenements de ${sessionScope.nomAsso}.</p>
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="card h-100">
          ...
          <div class="card-footer">
            <a href="ModifierEvent?titre=${ev.titre_event}" class="btn btn-primary">Aider</a>
