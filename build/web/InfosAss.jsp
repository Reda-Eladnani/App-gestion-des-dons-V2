...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="ProfilAssociation.java">Retour a votre profil</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <header class="jumbotron my-4" >
      ...
      <p class="lead">Voici vos informations et documents.</p>
...
<!--            <img class="card-img-top" src="" alt=""> -->
          <div class="card-body">
            ...
            <h4 class="card-title">Votre RIB : ${ass.rib}</h4>
          </div>
